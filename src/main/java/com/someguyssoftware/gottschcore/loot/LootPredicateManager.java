...
public class LootPredicateManager extends JsonReloadListener {
   ...
   private static final Gson field_227511_b_ = (new GsonBuilder()).registerTypeAdapter(RandomValueRange.class, new RandomValueRange.Serializer()).registerTypeAdapter(BinomialRange.class, new BinomialRange.Serializer()).registerTypeAdapter(ConstantRange.class, new Serializer()).registerTypeHierarchyAdapter(ILootCondition.class, new LootConditionManager.Serializer()).registerTypeHierarchyAdapter(LootContext.EntityTarget.class, new LootContext.EntityTarget.Serializer()).create();
   ...
   protected void apply(Map<ResourceLocation, JsonObject> splashList, IResourceManager resourceManagerIn, IProfiler profilerIn) {
      ...
      splashList.forEach((p_227514_1_, p_227514_2_) -> {
         try {
      ...
      validationtracker.func_227527_a_().forEach((p_227516_0_, p_227516_1_) -> {
