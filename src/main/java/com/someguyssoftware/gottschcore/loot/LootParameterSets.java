...
public class LootParameterSets {
   ...
   public static final LootParameterSet field_227557_c_ = register("command", (p_216250_0_) -> {
      p_216250_0_.required(LootParameters.POSITION).optional(LootParameters.THIS_ENTITY);
   });
   public static final LootParameterSet field_227558_d_ = register("selector", (p_216254_0_) -> {
