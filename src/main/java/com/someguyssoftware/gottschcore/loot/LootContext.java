...
public class LootContext {
   ...
   private final Function<ResourceLocation, LootTable> lootTableFromResourceLocationFunction;
   ...
   private LootContext(Random rand, float luckIn, ServerWorld worldIn, Function<ResourceLocation, LootTable> lootTableFromResourceLocationFunction, Function<ResourceLocation, ILootCondition> p_i225885_5_, Map<LootParameter<?>, Object> parametersIn, Map<ResourceLocation, LootContext.IDynamicDropProvider> conditionsIn) {
      this.random = rand;
      this.luck = luckIn;
      this.world = worldIn;
      this.lootTableFromResourceLocationFunction = lootTableFromResourceLocationFunction;
   ...
   public LootTable getLootTable(ResourceLocation tableId) {
      return this.lootTableFromResourceLocationFunction.apply(tableId);
   }
   ...
   public static class Builder {
      ...
      public Builder(ServerWorld worldIn, LootTableManager lootTableManager, LootPredicateManager lootPredicateManager) {
         this.world = worldIn;
         this.lootTableManager = lootTableManager;
         this.lootPredicateManager = lootPredicateManager;
      }

      public Builder(LootContext context, LootTableManager lootTableManager, LootPredicateManager lootPredicateManager) {
...
//               MinecraftServer minecraftserver = this.world.getServer();
               /*
                * FIX
                * instead of minecraftserver.getLootTableManager()::getLootTableFromLocation, call lootTableMaster.getLootTableFromLocation
