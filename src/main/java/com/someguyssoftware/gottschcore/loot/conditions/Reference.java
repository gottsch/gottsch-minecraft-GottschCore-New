...
import com.someguyssoftware.gottschcore.loot.ValidationTracker;
...
public class Reference implements ILootCondition {
   ...
   public boolean test(LootContext p_test_1_) {
      ILootCondition ilootcondition = p_test_1_.func_227504_b_(this.field_227562_b_);
      if (p_test_1_.func_227501_a_(ilootcondition)) {
         boolean flag;
         try {
            flag = ilootcondition.test(p_test_1_);
         } finally {
            p_test_1_.func_227503_b_(ilootcondition);
         }
