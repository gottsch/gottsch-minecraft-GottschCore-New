...
public class ValidationTracker {
	   ...
	   public ValidationTracker(Multimap<String, String> p_i225888_1_, Supplier<String> p_i225888_2_, LootParameterSet lootParameterSet, Function<ResourceLocation, ILootCondition> p_i225888_4_, Set<ResourceLocation> p_i225888_5_, Function<ResourceLocation, LootTable> p_i225888_6_, Set<ResourceLocation> p_i225888_7_) {
	      this.field_227519_a_ = p_i225888_1_;
	      this.field_227520_b_ = p_i225888_2_;
	      this.lootParameterSet = lootParameterSet;
	   ...
	   public ValidationTracker func_227534_b_(String p_227534_1_) {
	      ...
	      }, this.lootParameterSet, this.field_227522_d_, this.field_227523_e_, this.field_227524_f_, this.field_227525_g_);
	   }
	   ...
	   public ValidationTracker func_227531_a_(String p_227531_1_, ResourceLocation p_227531_2_) {
	      ...
	      }, this.lootParameterSet, this.field_227522_d_, this.field_227523_e_, this.field_227524_f_, immutableset);
	   }
	   ...
	   public ValidationTracker func_227535_b_(String p_227535_1_, ResourceLocation p_227535_2_) {
	      ...
	      }, this.lootParameterSet, this.field_227522_d_, immutableset, this.field_227524_f_, this.field_227525_g_);
	   }
	   ...
	   public void func_227528_a_(IParameterized p_227528_1_) {
	      this.lootParameterSet.func_227556_a_(this, p_227528_1_);
	   }
